...
### 🚧Ubuntu 22.04'e kurarken ilk önce alttaki dosyaların kurulumunu yapmamız gerekiyor. Bu işlemi sunucuya manuel olarak bağlanıp yapıyoruz.
```
...
### 8.606.342 Block Snapshot

- Launcher çalıştırın. kurulumu yapın loglar akmaya baslayınca sycn olurken durdurun log kısmından. sonra aşağıdaki işlemi yapın ve start deyin. Bu işlemi de sunucuya manuel olarak bağlanıp yapıyoruz. bu hizmetide corenode dan baskası yapmaz :D 
```
...
* 👉 https://play.google.com/store/apps/details?id=com.gamma.scan  androidler için uygulama elmalar için markete bakın yada grubda sorun bilenler vardır...
